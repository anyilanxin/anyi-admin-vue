...
import type { TableRowSelection as ITableRowSelection } from '@arco-design/web-vue/lib/table/interface'
import type { ColumnProps } from '@arco-design/web-vue/lib/table'

import { ComponentType } from './componentType'
import { VueNode } from '@anyi/coreutils'
...
export interface TableActionType {
  ...
  selectCustomChange: (row: Recordable, key: string, type: string) => void
