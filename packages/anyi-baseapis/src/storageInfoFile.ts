...
export function upload(
  ...
  return request.uploadFile<StorageInfoModel>(
    {
      url: SERVICE_API_PREFIX.STORAGE + '/storage-file/upload',
      onUploadProgress,
    },
    params,
  )
...
export function getUploadAction() {
  return apiUrl + SERVICE_API_PREFIX.STORAGE + '/storage-file/upload'
}
