...
<template>
  <a-layout has-sider class="h-full">
    ...
    >
      <div
        class="anyi-layout-left-menu"
        :class="menu.collapsedShowTitle ? 'anyi-layout-left-menu-show-title' : ''"
      >
        <slot name="sider">
          <Logo
            ref="logoRef"
            v-if="showSidebarLogo"
            :showTitle="!sidebar.collapsed"
            :backCg="sidebar.bgColor"
          />
          <BasicMenu :menuOptions="menuOptions"> </BasicMenu>
