...
<template>
  <TopButtonWrapper :content="username">
    <a-dropdown trigger="click">
      <a-avatar :size="32" :style="{ marginRight: '4px', marginLeft: '4px', cursor: 'pointer' }">
