...
<template>
  <div
    class="h-36px w-full absolute bottom-0 cursor-pointer grid-center anyi-sider-footer-trigger"
...
<style lang="less">
.anyi-sider-footer-trigger {
  border-top: 1px solid var(--trigger-border-color);
  display: inline-flex;
