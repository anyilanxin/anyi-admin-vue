...
import { StoreGeneric, storeToRefs, useSiteGeneral as siteGeneralStore } from '@anyi/corestores'

import { _merge } from '@anyi/coreutils'
import { DefineSiteGeneralOptions } from '@anyi/coretypes'
...
export const useSiteGeneral = () => {
  ...
  const initSiteGeneralConfig = (configs: DeepPartial<DefineSiteGeneralOptions>) => {
