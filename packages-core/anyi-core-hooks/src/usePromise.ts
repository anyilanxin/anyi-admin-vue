...
import { isEqual, containsProp, tryOnBeforeUnmount, useDebounceFn } from '@anyi/coreutils'
...
export function usePromise<T = any>(fn: (...args: any[]) => Promise<T>): UsePromiseReturnType<T>
